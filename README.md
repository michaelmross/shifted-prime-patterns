...
[*How dense can a set be while avoiding shifted-prime patterns?*](https://michaelmross.github.io/shifted-prime-patterns.html) (Ross, M. M., 2026)
...
| 10000 | 1229 | $1/130321$ | $52/3848 = 1/74$ ($m\le 20000$) | open |
| 30000 | 3245 | $1/1151329$ | $25/3145$ ($m\le 30000$) | open |
| 100000 | 9592 | $1/10029889$ | $21/5185$ ($m\le 60000$) | open |
| 300000 | 25997 | $1/27112849$ | $19/11041$ ($m\le 106567$) | open |
| 1000000 | 78498 | $1/347337769$ | $92/109922$ ($m\le 400000$) | open |
...
The ladder spans five decades, and the prefactor $\delta(X)\sqrt{X}$ tells
its story. Through $X=10^5$ it fluctuates in a band $[1.26,\,2.18]$ — the
records track $X^{-1/2}$, which under the window map $N=X^2$ is density
$N^{-1/4}$, just above the $N^{-0.267}$ shape of Ruzsa's square-difference
constructions — with the winning conductor always an order of magnitude below
the swept cap. The last two rungs then decline out of the band: $0.94$ at
$3\cdot10^5$ ($9.7\times$ coverage) and $0.84$ at $10^6$, whose coverage
question closed with a 94-hour blind sweep of $(150001, 400000]$ that found
nothing better — the slice maximum $184/219844$ exactly ties the record
($46/54961$ in lowest terms, attained at the doubled modulus by a different
coprime multiplier) — so the record stands at $3.6\times$ blind coverage and
the $k=2$ bend is a measured fact. The record at $10^6$ also changes shape — $m$ jumps tenfold
...
| 1000000 | $1160/54386$ ($m\le 200000$) | 0.021 | 0.00084 | 25.48 |
...
rungs — and then, at $X=10^5$, a dip below the band to $0.96$ that survived a cap
extension to $150000$ — $22.8\times$ the winner, with 119,858 alive moduli
scanned and none improving it. Within the interval family the dip is therefore
solid, not a cap artifact — and $X = 3\cdot10^5$ answered the recovery
question: the descent continues to $0.90$ ($322/10454$, unchanged across a
full sweep to $150000$, $14.3\times$ the winner). The $k=3$ bend is
sustained, not a one-rung sag. The mechanism escalates on schedule: the
...
floor, confirmed by a blind sweep to $m \le 200000$, $3.7\times$ the winner),
so the floor anchors the decline from below rather than pinning it;
